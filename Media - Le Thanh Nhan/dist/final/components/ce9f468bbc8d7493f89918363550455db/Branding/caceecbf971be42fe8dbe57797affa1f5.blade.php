<div class="ce9f468bbc8d7493f89918363550455db" id="caceecbf971be42fe8dbe57797affa1f5">
    ...
    <div class="container-lg ce9f468bbc8d7493f89918363550455db__wrapper">
        ...
        <div class="ce9f468bbc8d7493f89918363550455db__right flex-column order-first">
            <h2>{{ $content->title }}</h2>
            <p>{!! $content->content !!}</p>
            ...
            <a href="{{route('article', ['alias' => $content->alias])}}" class="ce9f468bbc8d7493f89918363550455db__button hover-white z-999">
